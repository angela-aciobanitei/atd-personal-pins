...
import com.ang.acb.personalpins.utils.ImageSaver;
...
public class PhotoFragment extends Fragment
    ...
    // A CaptureRequest generated by the CaptureRequest.Builder for the camera preview
    private CaptureRequest mPreviewRequest;

    // Called when {@link CameraDevice} changes its state.
    ...
    // The output file for our picture.
    private File mFile;

    // A callback object for the {@link ImageReader}. "onImageAvailable" will be
    // called when a still image is ready to be saved.
   ...
   // A Semaphore to prevent the app from exiting before closing the camera.
    ...
    // The current state of camera state for taking pictures. @see #mCaptureCallback
    ...
    public void onResume() {
        ...
        // we can open a camera and start preview from here (otherwise, we wait until the
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // We won't use a front facing camera in this sample.
